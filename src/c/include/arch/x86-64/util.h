...
#define ARC_HALT              __asm__ volatile ("hlt");
#define ARC_HANG term_draw(); __asm__ volatile ("1: hlt; jmp 1b");
#define ARC_DISABLE_INTERRUPT __asm__ volatile ("cli");
#define ARC_ENABLE_INTERRUPT  __asm__ volatile ("sti");
